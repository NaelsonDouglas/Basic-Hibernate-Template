...
CREATE TABLE `DISCIPLINA_ALUNO`(
	...
	KEY `FK_DISCIPLINA_ALUNO_DISCIPLINA` (`DISCIPLINA_ID`),
	KEY `FK_DISCIPLINA_ALUNO_ALUNO` (`ALUNO_ID`),
	CONSTRAINT `FK_DISCIPLINA_ALUNO_DISCIPLINA` FOREIGN KEY (`DISCIPLINA_ID`) REFERENCES `DISCIPLINA` (`DISCIPLINA_ID`),
	CONSTRAINT `FK_DISCIPLINA_ALUNO_ALUNO` FOREIGN KEY (`ALUNO_ID`) REFERENCES `ALUNO` (`ALUNO_ID`)
);
